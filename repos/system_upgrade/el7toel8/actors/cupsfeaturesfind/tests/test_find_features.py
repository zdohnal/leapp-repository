...
from leapp.libraries.actor.library import find_features
...
testdata = (
    ...
    (
        ...
        {},
        {
            'error': 'Core CUPS configuration files are missing. CUPS in'
                     'stallation is corrupted, terminating the actor.'
        }
    ),
    (
        ['cups'],
