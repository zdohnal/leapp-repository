...
from leapp.libraries.actor.library import migrate_configuration
...
class MockModel(object):
    def __init__(self, include, include_files, digest,
                 env, certkey, printcap):
        self.model = CupsChangedFeatures(include=include,
...
def test_migrate_configuration(facts, expected):
    data_model = MockModel(include=facts.get('include', False),
